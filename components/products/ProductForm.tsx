  ...
  useEffect(() => {
    if (product) {
      setFormData({
       ...
       setFormData({
            sku: '', name: '', category: '', cost: 0, price: 0, stock: 0, reorder_level: 5,
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
       ...
       <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Input label="Costo" name="cost" type="number" value={formData.cost} onChange={handleChange} required />
        <Input label="Precio de Venta" name="price" type="number" value={formData.price} onChange={handleChange} required />
      ...
      <div>
        ...
        <textarea name="description" value={formData.description} onChange={handleChange} rows={3} className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
      </div>
